<?php 
    ...
    if (isset($_POST['comment'])){
		...
		Someone commented on your photo. Check it out
			
        http://localhost:8080/Gallery.php?email=$Email";
    ...
    <body>
        <nav class="navbar navbar-light">
            ...
            <div style="position:absolute; right:5%;">
               ...
               <a class="navbar-nav" href="admin.php" style="margin:16px 5px;">Change credentials</a> 
            ...
            <?php
                ...
                for($i = count($files) - 1; $i >= 0;$i--){
                    ...
                    echo '
                        ...
                        <button id="like" style="margin-top:10px;" class="btn btn-primary center-block" name="unliked" type="submit"><i class="glyphicon glyphicon-thumbs-down"></i> UNLIKE</button>
                        </form>
